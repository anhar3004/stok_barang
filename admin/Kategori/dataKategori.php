                    ...
                    <table class="table table-striped table-advance table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="beranda.php?hal=ubahKategori&kode_kategori=<?php echo $data['kode_kategori']?>"
                                        class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i></a>
                                    <a href="beranda.php?hal=hapusKategori&kode_kategori=<?php echo $data['kode_kategori']?>"
