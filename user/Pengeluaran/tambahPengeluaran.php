<?php
    include "../connect.php";
    $today = date("ymd");
    $query = "SELECT max(kode_keluar) as maxCode FROM tb_pengeluaran";
    ...
    if($_SERVER['REQUEST_METHOD']=="POST" && isset($_POST['simpan'])){
        ...
        $simpan = mysqli_query($connect,"INSERT INTO tb_pengeluaran VALUES ('$kode_keluar','$today','$jumlah_item','$kode_departement','$id_login','$keterangan')");
        if(simpan){
            //memindahkan data yang ada di tabel_sementara ke tabel detail_penerimaan
            $simpanTMP = mysqli_query($connect,"INSERT INTO tb_detail_pengeluaran (kode_keluar,kode_barang,jumlah_barang) SELECT kode,kode_barang,jumlah from tb_sementara");

            //hapus semua data yang ada di tabel sementara 
            $hapusTMP = mysqli_query($connect,"DELETE FROM tb_sementara ") or die (mysqli_error());

            echo "<script>
            windows.alert('Data Pengeluaran Barang Berhasil Di simpan');
            </script>";
...
<section id="main-content">
    <section class="wrapper">
        ...
        <div class="form-panel">
            <h4 class="mb text-center"><i class="fa fa-backward"></i> Tambah Pengeluaran Barang</h4>
            <div class="row mt">
                <div class="col-md-12">
                    <div class="row mt">
                        <div class="col-md-6">
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="beranda.php?hal=hapusSementaraKeluar&id=<?php echo $data['id']?>"
        ...
        <div class="form-panel">
            <h4 class="mb text-center"><i class="fa fa-save"></i> Simpan Pengeluaran Barang</h4>
            <div class="row mt">
                <div class="col-md-12">
                    <div class="row mt">
                        <div class="col-md-6">
                               ...
                               ?>
                                ...
                                <div class="form-group">
                                    <div class="">
                                        ...
                                        <a href="?hal=dataPengeluaran" class="btn btn-warning">Kembali</a>
                                    </div>
                                </div>
                        </div>
                        <div class="col-md-6">
